...
// por lo que este archivo debería llamarse "DIVISORES_SUMA.java."
...
public class divisores_suma {

	public static double sumadivisores(double a) {
		double divisor;
		double resto;
		double suma;
		double sumadiva;
	...
	public static void main(String args[]) throws IOException {
		...
		res = (sumaa==b) && (sumab==a);
		if (res==true) {
			System.out.println("Los dos números SÍ son amigos");
		} else {
